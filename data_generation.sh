...
# FastQ
${GRINDER} -rf $1 -tr $2 -rd 101 uniform 10 -md poly4 3e-3 3.3e-8 -mr 80 20 -am uniform -od ${RESULTS} -ql 30 10 -fq 1
mv "${RESULTS}grinder-reads.fastq" ${READS_FQ}
rm "${RESULTS}/grinder*"
# Fastq to Fasta
