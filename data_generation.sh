...
### Execution
echo "### (1/2) Now executing: grinder | Read Generation" &>> ${LOG}
# Fasta ${GRINDER} -rf $1 -tr $2 -rd 101 uniform 10 -md poly4 3e-3 3.3e-8 -mr 80 20 -am uniform
# FastQ
${GRINDER} -rf ${MULTIFASTA} -tr ${N_READS} -rd 101 uniform 10 -md poly4 3e-3 3.3e-8 -mr 80 20 -am uniform -od ${ASM} -ql 30 10 -fq 1
...
# MEGAHIT - Assembly (-t 12)
echo "### (2/2) Now executing: megahit | Contig assembly" &>> ${LOG}
${MEGAHIT} --kmin-1pass --k-min 27 --k-step 10 --k-max 87 -r ${READS_FA} -o ${ASSEMBLY} &>> ${LOG}
