...
int main(int argc, char** argv){
	...
	if (argc < 6)//				0					1							2						3		4			5	
			terror("USE: ./uniseqDBCoverage <Fixed_Parsed_Blast_Reads> <Fixed_Parsed_Blast_Contigs> <DB.taxo> <uniseqDB> <Output>");
	...
	fprintf(finfo, "ReadOnly\tContigOnly\tBothYes\tBothNo\n");
